...
export declare class BudgetSubmissionController {
    ...
    private readonly capexRepo;
    private readonly workflowService;
    private readonly lockedLineItemService;
    private readonly unitSubmissionService;
    constructor(submissionRepo: Repository<BudgetSubmission>, itemRepo: Repository<BudgetItem>, branchRepo: Repository<Branch>, cycleRepo: Repository<BudgetCycle>, categoryRepo: Repository<ExpenseCategory>, capexRepo: Repository<CapexBusinessCase>, workflowService: WorkflowService, lockedLineItemService: LockedLineItemService, unitSubmissionService: UnitSubmissionService);
