...
exports.WorkflowModule = WorkflowModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([budget_submission_entity_1.BudgetSubmission, budget_item_entity_1.BudgetItem, workflow_audit_entity_1.WorkflowAudit, user_entity_1.User, notification_entity_1.Notification, opex_budget_entity_1.OpexBudget]),
